...
def plot_surface(x, y, z=np.array([[i]*100 for i in range(100)])):
    """los datos de z son de una sola dimension (1 z para cada x, y), por defecto
    se incluye una malla de 100 x 100"""
    fig = plt.figure(figsize=(10, 10))
    ax = fig.add_subplot(111, projection='3d')
    ax.plot_surface(x, y, z)
    ax.set_title("Sigmoide 3d")
    plt.xlabel('Eje X')
    plt.ylabel('Eje Y')
    plt.show()


def plot_wireframe(x, y, z=np.array([[i]*100 for i in range(100)])):
...
def plot_scatter(x, y, z=np.array([i for i in range(100)])):
...
def plot_trisurf(x, y, z=np.array([i for i in range(100)])):
    """los datos de z son de una sola dimension (1 z para cada x, y)"""
    fig = plt.figure(figsize=(10, 10))
...
def plot_bar(x, y, z=np.array([i for i in range(100)])):
    """los datos de z son de una sola dimension (1 z para cada x, y)"""
    fig = plt.figure(figsize=(10, 10))
    ax = fig.add_subplot(111, projection='3d')
